...
## 4. Configuring Multi-Factor Authentication (MFA)
 ...
 - By Default you can also create Multi-Factor Authentication on Microsoft 365 allowing you sign in into your account using an authenticator by scanning the QR Code using your mobile device or whatever.
