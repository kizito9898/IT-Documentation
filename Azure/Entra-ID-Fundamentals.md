...
**Microsoft Entra ID (formerly Azure Active Directory)** is a cloud-based identity and access management (IAM) service from Microsoft. It helps organizations manage **user identities, authentication, and security policies** for applications and devices in Microsoft 365 and Azure environments. it is a cloud based version of the on-premises Active Directory uses and computers and it can be configured as a Hybrid solution known as Entra ID 
