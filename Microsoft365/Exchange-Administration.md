...
A **shared mailbox** allows multiple users to access and send emails from a single mailbox (e.g., `Procuremnent-Team@Njikason.onmicrosoft.com`).  

#### **Steps:**  
1. Go to **Exchange Admin Center**.  
2. Navigate to **Recipients > Mailboxes**.  
3. Click **Add Mailbox > Shared Mailbox**.  
4. Enter a **name** (e.g., "Procurement-Team") and **email address** (e.g., `Procurement-Team@Njikason.onmicosoft.com).  
